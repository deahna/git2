...
public class DecimalToBinaryPractice extends JPanel implements GenerateProblem , ActionListener
{
	...
	public void showQuestion(int articleQuestion) 
	{
		...
		instructionLabel = new JLabel("Convert This Decimal Number to Binary! " + convertValue);
	...
	public DecimalToBinaryPractice()
	{		
		showQuestion(1);
	...
	public static void initPracticeProblem()
	{
		...
		JFrame frame = new JFrame("Decimal to Binary Practice Problem.");
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		
		DecimalToBinaryPractice pane = new DecimalToBinaryPractice();
