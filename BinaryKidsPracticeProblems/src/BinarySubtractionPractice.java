...
public class BinarySubtractionPractice extends JPanel implements GenerateProblem , ActionListener
{
	...
	public void showQuestion(int articleQuestion) 
	{
		...
		instructionLabel = new JLabel("Calculate the subtraction of these two binary values! " + convertValue + convertValue);
	...
	public BinarySubtractionPractice()
	{		
		showQuestion(1);
	...
	public static void initPracticeProblem()
	{
		...
		JFrame frame = new JFrame("Binary Subtraction Practice Problem.");
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		
		BinarySubtractionPractice pane = new BinarySubtractionPractice();
