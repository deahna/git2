...
public class BinaryAdditionPractice extends JPanel implements GenerateProblem , ActionListener
{
	...
	public void showQuestion(int articleQuestion) 
	{
		...
		instructionLabel = new JLabel("Calculate the addtion of these two binary numbers" + convertValue + convertValue);
	...
	public static void initPracticeProblem()
	{
		...
		JFrame frame = new JFrame("Binary Addition Practice Problem.");
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		
	    BinaryAdditionPractice pane = new BinaryAdditionPractice();
